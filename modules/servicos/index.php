...
/**
 * MÓDULO: SERVIÇOS
 * Arquivo: index.php - Listagem de serviços navais e preços
 */
...
<div class="conteudo-principal">
    <div class="tabela-container">
        <div class="tabela-header">
            ...
            <a href="<?php echo APP_URL; ?>servicos/form" class="btn btn-primary btn-sm">
                    ...
                    <tr class="<?php echo $s['ativo'] ? '' : 'linha-inativa'; ?>">
                        ...
                        <td>
                            <div class="d-flex gap-1">
                                <a href="<?php echo APP_URL; ?>servicos/form?id=<?php echo urlencode($s['id']); ?>"
                                   class="btn btn-secondary btn-sm" title="Editar">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <?php if ($s['ativo']): ?>
                                    <a href="<?php echo APP_URL; ?>servicos/actions?action=desativar&id=<?php echo urlencode($s['id']); ?>"
                                ...
                                <?php else: ?>
                                    <a href="<?php echo APP_URL; ?>servicos/actions?action=reativar&id=<?php echo urlencode($s['id']); ?>"
