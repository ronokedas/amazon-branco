 ...
 * Módulo de Autenticidade: Endpoint de Cancelamento de Aprovação Eletrônica
 */
...
try {
    ...
    if (getCargo() !== 'ADMIN') {
        ...
        throw new RuntimeException('Apenas administradores podem cancelar documentos aprovados.');
    }
    ...
    if (!verificarCSRF($_POST['csrf_token'] ?? '')) {
        ...
        throw new RuntimeException('Sessao expirada. Atualize a pagina.');
    }
