 ...
 * Módulo de Autenticidade: Validação Pública de Assinaturas Digitais
 */
...
$stmt = $pdo->prepare("SELECT da.*,
        ra.nome_completo,ra.cargo_titulo,ra.registro_profissional,ra.uuid as responsavel_uuid,
...
<head>
    <meta charset="utf-8">
    <title>Validação pública de documento - Autenticidade</title>
