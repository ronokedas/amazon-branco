...
try{
 ...
 if($acao==='confirmar'){
  ...
  $rel='storage/protocolos/'.date('Y').'/'.$id.'/evento-'.str_pad((string)$m['sequencia'],2,'0',STR_PAD_LEFT).'.pdf';$abs=__DIR__.'/../../'.$rel;if(!is_dir(dirname($abs))){@mkdir(dirname($abs),0777,true);@chmod(dirname($abs),0777);}
