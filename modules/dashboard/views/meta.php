...
<section class="goal-card<?= $meta['percentual']>=100?' is-complete':'' ?><?= $meta['mensagem']!==''?' has-message':'' ?>">
    ...
    <div class="goal-card__body"><span>Meta compartilhada de <?= $mesAtual ?></span><h2><?= $meta['percentual']>=100?'Meta alcançada!':'Estamos avançando juntos' ?></h2><div class="goal-card__bar"><i style="width:<?= $percent ?>%"></i></div>
