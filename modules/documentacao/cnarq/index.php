...
<div class="conteudo-principal">
    <div class="tabela-header">
        ...
        <div class="d-flex gap-2">
            <a href="<?php echo APP_URL; ?>documentacao/cnarq/form" class="btn btn-success">
    ...
    <div class="tabela-container">
        <?php if (empty($certificados)): ?>
            <div class="tabela-vazia">
                ...
                <a href="<?php echo APP_URL; ?>documentacao/cnarq/form" class="btn btn-success btn-sm">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-1" style="flex-wrap: nowrap;">
                                    ...
                                    <!-- Link de Assinatura -->
                                    <?php
                                    $token_stmt = $pdo->prepare("SELECT token_assinatura FROM certificados_cnarq WHERE id = :id");
