...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <?php if (podeAcessar('protocolos_documentais')): ?><a href="<?= APP_URL ?>protocolos" class="nav-item<?= strpos($pagina_atual,'protocolos')===0?' active':'' ?>" data-label="Protocolos documentais"><i class="fa-solid fa-arrow-right-arrow-left"></i><span class="nav-text">Protocolos</span></a><?php endif; ?>
        ...
        <a href="<?= APP_URL ?>minhas-assinaturas" class="nav-item<?= isActive('minhas-assinaturas',$pagina_atual) ?>" data-label="Minhas assinaturas"><i class="fa-solid fa-file-signature"></i><span class="nav-text">Minhas assinaturas</span></a>
