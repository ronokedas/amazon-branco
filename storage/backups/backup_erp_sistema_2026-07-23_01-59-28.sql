...
CREATE TABLE `analise_planos_exigencias` (
  ...
  `status` enum('PENDENTE','CUMPRIDA','PARCIAL','TRANSCRITA') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'PENDENTE',
...
CREATE TABLE `analise_planos_pareceres` (
  ...
  `status` enum('MINUTA','AGUARDANDO_APROVACAO','PUBLICADO','CANCELADO') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'MINUTA',
...
CREATE TABLE `analises_planos` (
  ...
  `tipo_processo` enum('LC','LCEC','LA','LR','OUTRO') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `enquadramento` enum('NORMAM-201','NORMAM-202','OUTRO') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `analista_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `responsavel_assinatura_id` int DEFAULT NULL,
  `status` enum('RASCUNHO','EM_ANALISE','AGUARDANDO_CORRECAO','AGUARDANDO_APROVACAO','CONCLUIDA','REPROVADA','CANCELADA') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'RASCUNHO',
  `observacoes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `criado_por` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `criado_em` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `atualizado_em` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
INSERT INTO `campo_sessoes` VALUES
('670ad30a88a88ed1eabe01321cb3ecaa945e0028a7b82fc40cda72a175cf650d','d2a16613-dfa4-4948-8de4-8c802abdf394','2026-07-21 19:43:57','2026-07-21 19:45:58','2027-07-21 19:45:58',NULL,'51fb9c0c4a5c7bb3297f439736ef5d3d8ad8500c5f1f91e4b8dfa0064380cb99','6235d36597d64fc0e0c3883911a8fb2f9451d0254ab3379d980f5a3426585d87'),
('728f15bf18cc8fa2d869d0cdae7b29ec44c32b108be9abf0adc60e4f010162d8','d2a16613-dfa4-4948-8de4-8c802abdf394','2026-07-22 03:39:21','2026-07-22 03:39:21','2027-07-22 03:39:21',NULL,'51fb9c0c4a5c7bb3297f439736ef5d3d8ad8500c5f1f91e4b8dfa0064380cb99','6235d36597d64fc0e0c3883911a8fb2f9451d0254ab3379d980f5a3426585d87'),
('b462e48940a2ff38a7b6deb5f621eaa5a61a73ef2600d9eafb20344cd9d2f79c','d2a16613-dfa4-4948-8de4-8c802abdf394','2026-07-22 03:39:06','2026-07-22 03:39:19','2027-07-22 03:39:19','2026-07-22 03:39:19','51fb9c0c4a5c7bb3297f439736ef5d3d8ad8500c5f1f91e4b8dfa0064380cb99','6235d36597d64fc0e0c3883911a8fb2f9451d0254ab3379d980f5a3426585d87');
...
('1801fc90-5734-417c-acf2-fed7399a23f1','Matriz','Ananindeua','PA',1,'2026-07-20 15:13:20','2026-07-21 14:16:27');
...
CREATE TABLE `feedback_anexos` (
  ...
  `mensagem_id` char(36) COLLATE utf8mb4_general_ci NOT NULL,
  `nome_arquivo` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `chave_arquivo` varchar(600) COLLATE utf8mb4_general_ci NOT NULL,
  `tipo_mime` varchar(150) COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `feedback_anexos` VALUES
('b763894d-d694-4741-8569-72ef80b3c7df','d305a1a8-09f6-43a3-bc98-749d6e7bf08e','p1.jpeg','local:feedback/8eb0e48b-37bd-4473-96f1-ec9a9f8e4851/a48896e7-46c3-4c19-8a2c-4c78c5442daf.jpeg','image/jpeg','jpeg',80925,'ed587f2f60958b133c0be750e53707f82c5bb3f77b194a30b20ea1223788805e','2026-07-21 16:19:17');
...
CREATE TABLE `feedback_mensagens` (
  `id` char(36) COLLATE utf8mb4_general_ci NOT NULL,
  `feedback_id` char(36) COLLATE utf8mb4_general_ci NOT NULL,
  `autor_id` char(36) COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `feedback_mensagens` VALUES
('d305a1a8-09f6-43a3-bc98-749d6e7bf08e','8eb0e48b-37bd-4473-96f1-ec9a9f8e4851','ab8d4e66-d57a-44b1-8d8c-9c928a2e68c5','quando vou ter aumento de salario?','2026-07-21 16:19:17'),
('e49ef28b-9d21-45e2-98de-fef0cb981466','8eb0e48b-37bd-4473-96f1-ec9a9f8e4851','dd121661-feb4-42f6-895a-68eb0608d1e4','ok','2026-07-21 16:20:40');
...
INSERT INTO `feedback_participantes` VALUES
('8eb0e48b-37bd-4473-96f1-ec9a9f8e4851','ab8d4e66-d57a-44b1-8d8c-9c928a2e68c5',1,NULL,'2026-07-21 16:19:17','2026-07-21 16:22:09'),
('8eb0e48b-37bd-4473-96f1-ec9a9f8e4851','dd121661-feb4-42f6-895a-68eb0608d1e4',1,NULL,'2026-07-21 16:19:17','2026-07-21 16:20:40');
...
CREATE TABLE `feedback_regras_comunicacao` (
  `id` char(36) COLLATE utf8mb4_general_ci NOT NULL,
  `cargo_origem` enum('ADMIN','VENDEDOR','VISTORIADOR','ANALISTA') COLLATE utf8mb4_general_ci NOT NULL,
  `escopo` enum('ADMIN','GESTOR_DIRETO','SUBORDINADOS','OUTROS_GESTORES','CARGO','TODOS_USUARIOS') COLLATE utf8mb4_general_ci NOT NULL,
  `cargo_destino` enum('ADMIN','VENDEDOR','VISTORIADOR','ANALISTA') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `chave_destino` varchar(20) COLLATE utf8mb4_general_ci GENERATED ALWAYS AS (coalesce(`cargo_destino`,_utf8mb4'')) STORED,
  `ativo` tinyint(1) NOT NULL DEFAULT '1',
  `criado_em` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `atualizado_em` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
('3579e827-8516-11f1-a50d-aa44e656c57d','ANALISTA','ADMIN',NULL,'',1,'2026-07-21 15:09:45','2026-07-21 15:09:45'),
('3579ea29-8516-11f1-a50d-aa44e656c57d','VISTORIADOR','ADMIN',NULL,'',1,'2026-07-21 15:09:45','2026-07-21 15:09:45'),
('3579ebca-8516-11f1-a50d-aa44e656c57d','VENDEDOR','ADMIN',NULL,'',1,'2026-07-21 15:09:45','2026-07-21 15:09:45'),
('3579ec9e-8516-11f1-a50d-aa44e656c57d','ANALISTA','GESTOR_DIRETO',NULL,'',1,'2026-07-21 15:09:45','2026-07-21 15:09:45'),
('3579ed05-8516-11f1-a50d-aa44e656c57d','VISTORIADOR','GESTOR_DIRETO',NULL,'',1,'2026-07-21 15:09:45','2026-07-21 15:09:45'),
('3579ed5b-8516-11f1-a50d-aa44e656c57d','VENDEDOR','GESTOR_DIRETO',NULL,'',1,'2026-07-21 15:09:45','2026-07-21 15:09:45'),
('3579eda7-8516-11f1-a50d-aa44e656c57d','ANALISTA','SUBORDINADOS',NULL,'',1,'2026-07-21 15:09:45','2026-07-21 15:09:45'),
('3579edf2-8516-11f1-a50d-aa44e656c57d','VISTORIADOR','SUBORDINADOS',NULL,'',1,'2026-07-21 15:09:45','2026-07-21 15:09:45'),
('3579ee41-8516-11f1-a50d-aa44e656c57d','VENDEDOR','SUBORDINADOS',NULL,'',1,'2026-07-21 15:09:45','2026-07-21 15:09:45'),
('3579ee8c-8516-11f1-a50d-aa44e656c57d','ANALISTA','OUTROS_GESTORES',NULL,'',1,'2026-07-21 15:09:45','2026-07-21 15:09:45'),
('3579eed6-8516-11f1-a50d-aa44e656c57d','VISTORIADOR','OUTROS_GESTORES',NULL,'',1,'2026-07-21 15:09:45','2026-07-21 15:09:45'),
('3579ef21-8516-11f1-a50d-aa44e656c57d','VENDEDOR','OUTROS_GESTORES',NULL,'',1,'2026-07-21 15:09:45','2026-07-21 15:09:45'),
('84c4a7a1-8523-11f1-a50d-aa44e656c57d','VENDEDOR','TODOS_USUARIOS',NULL,'',1,'2026-07-21 16:45:02','2026-07-21 16:45:02'),
('84c4a9f4-8523-11f1-a50d-aa44e656c57d','VISTORIADOR','TODOS_USUARIOS',NULL,'',1,'2026-07-21 16:45:02','2026-07-21 16:45:02'),
('84c4aa7c-8523-11f1-a50d-aa44e656c57d','ANALISTA','TODOS_USUARIOS',NULL,'',1,'2026-07-21 16:45:02','2026-07-21 16:45:02');
...
CREATE TABLE `feedbacks` (
  `id` char(36) COLLATE utf8mb4_general_ci NOT NULL,
  `remetente_id` char(36) COLLATE utf8mb4_general_ci NOT NULL,
  `destinatario_id` char(36) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'NULL representa a caixa compartilhada dos administradores',
  `categoria` enum('DUVIDA','SUGESTAO','BUG','RECLAMACAO','ELOGIO') COLLATE utf8mb4_general_ci NOT NULL,
  `prioridade` enum('BAIXA','MEDIA','ALTA','URGENTE') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'MEDIA',
  `status` enum('ABERTO','RESPONDIDO','RESOLVIDO') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'ABERTO',
  `criado_em` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `atualizado_em` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
('8eb0e48b-37bd-4473-96f1-ec9a9f8e4851','ab8d4e66-d57a-44b1-8d8c-9c928a2e68c5',NULL,'DUVIDA','URGENTE','RESOLVIDO','2026-07-21 16:19:17','2026-07-21 16:22:09');
...
('148917a3-254c-44a7-9abf-c091758900fe','2026-07-01','1801fc90-5734-417c-acf2-fed7399a23f1',NULL,200000.00,'Ao bater a meta, o Neto vai pagar 5 salários extra pra cada um!!!','2026-07-21 14:27:38','2026-07-21 14:27:38'),
('60c5293d-850c-11f1-a50d-aa44e656c57d','2026-07-01','00000000-0000-4000-8000-000000000100',NULL,180000.00,'Ao bater a meta, teremos um dia especial com toda a equipe.','2026-07-21 13:59:23','2026-07-21 14:18:49');
...
(1,'d2a16613-dfa4-4948-8de4-8c802abdf394','campo_login','Login no aplicativo de campo.','172.23.0.1','2026-07-21 16:43:57'),
(2,'d2a16613-dfa4-4948-8de4-8c802abdf394','campo_login','Login no aplicativo de campo.','172.23.0.1','2026-07-22 00:39:06'),
(3,'d2a16613-dfa4-4948-8de4-8c802abdf394','campo_logout','Logout do aplicativo de campo.','172.23.0.1','2026-07-22 00:39:19'),
(4,'d2a16613-dfa4-4948-8de4-8c802abdf394','campo_login','Login no aplicativo de campo.','172.23.0.1','2026-07-22 00:39:21');
...
CREATE TABLE `portal_auditoria` (
  ...
  `evento` enum('LOGIN_SUCESSO','LOGIN_FALHA','VISUALIZACAO','DOWNLOAD') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
('ab8d4e66-d57a-44b1-8d8c-9c928a2e68c5','1801fc90-5734-417c-acf2-fed7399a23f1',1,'2026-07-21 19:58:58'),
...
('ab8d4e66-d57a-44b1-8d8c-9c928a2e68c5','analise_planos',0,'2026-07-21 16:21:37'),
...
('9cd7e53a-da9d-4f2b-9b32-328be32da2f0','itamar','analista@teste.com','$2y$10$PftOdZbu7u.NZ65.r1NpO.s4jBDtysUHLwrLVH0jxALGB/VlWvn.2','ANALISTA',1,NULL,'2026-07-16 15:38:12','2026-07-20 15:13:20',0,0,'1801fc90-5734-417c-acf2-fed7399a23f1',NULL),
('ab8d4e66-d57a-44b1-8d8c-9c928a2e68c5','any','vendedor@teste.com','$2y$10$3j2BvFNQytOeftJk4nWwHORcMqt9Ru5Jahqn7KjoDPS7pI6w0re.u','VENDEDOR',1,NULL,'2026-07-21 12:47:52','2026-07-21 19:58:58',0,0,'1801fc90-5734-417c-acf2-fed7399a23f1',NULL),
('d2a16613-dfa4-4948-8de4-8c802abdf394','Neto','teste1@teste.com','$2y$10$nho8g81ikeWtP9U7G3Ft7uHZOARhHcfD.oVRW5/hMKQnZ7MRsLxOy','VISTORIADOR',1,NULL,'2026-07-07 21:10:28','2026-07-21 19:44:55',1,0,'1801fc90-5734-417c-acf2-fed7399a23f1',NULL),
('dd121661-feb4-42f6-895a-68eb0608d1e4','teste admin','teste@teste.com','$2y$10$eK05TTRWPQmp7ldYEALHrOMRSVKUGMo6yqVv3kCU0yYiOz5KzBWw6','ADMIN',1,NULL,'2026-07-05 13:39:17','2026-07-21 19:58:58',0,0,'1801fc90-5734-417c-acf2-fed7399a23f1',NULL),
...
-- Dump completed on 2026-07-23  4:59:28
