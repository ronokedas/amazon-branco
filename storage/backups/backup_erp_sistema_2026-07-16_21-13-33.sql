...
CREATE TABLE `cert_convalidacoes` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT (uuid()),
  `tipo_certificado` enum('CNBL','CNARQ') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Tipo de certificado ao qual a convalidaÃ§Ã£o pertence',
...
('balsa901-2026-4abc-8def-000000000001',NULL,'Balsa Estrela do Tapajós','Balsa','06a95b60-75d0-11f1-98f0-5ed0db5eacb7','Balsa','B',0,'Não se aplica - embarcação sem propulsão própria','0 kW','AM-BAL-2026-901','Navegação Tapajós Ltda.',2024,NULL,42.50,41.80,40.20,3.20,12.00,12.30,'Aço','Transporte de Carga','Interior','Área 1','Área 1','386.50','021045678-9','Santarém - PA','PP9012',4,0,0,'Balsa de convés aberto destinada ao transporte de cargas gerais em navegação interior. Dados integralmente fictícios.',1,'95eb5557-65e8-11f1-85ef-047c16b568a3','2026-07-16 23:32:59','2026-07-16 23:32:59',1,'Não autorizada ao transporte de passageiros.',0,'Santarém - PA','ET-BA-024-091',620.00,'Estaleiro Tapajós Engenharia Naval Ltda.','12.345.678/0001-90','Avenida Cuiabá, 1500, Área Portuária, Santarém - PA, CEP 68040-400',270.55,'Regra II','15/03/2023',2.400,'Convés principal | Meia-nau | 40,20 m\nCasaria de popa | Popa | 4,80 m','Espaço de carga | Convés principal | 36,00 m',18.75,'Santarém - PA, 20 de maio de 2024','Não houve rearqueação',620,'Tipo B',2.40,'620','710','18400','90','710','795','85'),
('empur902-2026-4abc-8def-000000000002',NULL,'Empurrador Forte do Amazonas','Empurrador','06a95eb2-75d0-11f1-98f0-5ed0db5eacb7','Empurrador','B',1,'Caterpillar, modelo C18 ACERT, dois motores diesel marítimos','2 x 447 kW (2 x 600 HP)','AM-EMP-2026-902','Logística Fluvial Amazonas S.A.',2023,NULL,22.80,22.20,20.90,3.60,8.40,8.65,'Aço','Empurra','Interior','Área 2','Área 2','198.40','021045679-7','Manaus - AM','PP9023',8,0,0,'Empurrador fluvial destinado à formação e condução de comboios de balsas em navegação interior. Dados integralmente fictícios.',1,'95eb5557-65e8-11f1-85ef-047c16b568a3','2026-07-16 23:32:59','2026-07-16 23:32:59',0,'Somente tripulação de segurança e operação.',1,'Manaus - AM','AMZ-EMP-023-118',92.50,'Estaleiro Rio Negro Construções Navais Ltda.','98.765.432/0001-10','Rua da Indústria Naval, 880, Distrito Industrial, Manaus - AM, CEP 69075-100',138.90,'Regra II','08/08/2022',2.650,'Praça de máquinas | Meia-nau | 8,20 m\nAlojamentos | Convés superior | 7,50 m\nPassadiço | Convés do tijupá | 4,20 m','Praça de máquinas | Meia-nau | 8,20 m\nAlojamento da tripulação | Convés superior | 6,80 m',12.40,'Manaus - AM, 14 de fevereiro de 2023','Não houve rearqueação',740,'Tipo B',2.65,'740','825','9200','85','825','920','95');
...
CREATE TABLE `financeiro_lancamentos` (
  ...
  `status` enum('PENDENTE','PAGO','CANCELADO') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'PAGO',
...
CREATE TABLE `propostas` (
  ...
  CONSTRAINT `chk_propostas_assinatura_status` CHECK (((`assinado` = 0) or (`status` = _utf8mb4'assinada')))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
('95eb5557-65e8-11f1-85ef-047c16b568a3','Administrador','admin@sistema.com','$2y$10$me4J46xJEQ9k/UEKfdlRBeWtGclStZKVFSH.HxqVjmsX/8ur8b.GC','ADMIN',1,'2026-06-11 19:55:04','2026-07-16 23:31:57',0,0),
...
-- Dump completed on 2026-07-17  0:13:33
